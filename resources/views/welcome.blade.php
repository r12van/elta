...
<head>
    ...
    <title>Sistem Pelaporan Kinerja Tenaga Ahli - Disgulkarmat DKI</title>
...
<body class="antialiased font-sans bg-gray-50 text-gray-900">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                <div class="flex-shrink-0 flex items-center gap-2">
                    ...
                    <span class="font-bold text-xl tracking-tight text-gray-800 hidden sm:block">E-Kinerja <span class="text-blue-600">Tenaga Ahli</span></span>
                </div>
    ...
    <div class="bg-white py-20 border-t border-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl font-bold text-gray-900">Kenapa Menggunakan E-Kinerja Tenaga Ahli?</h2>
    ...
    <footer class="bg-white border-t border-gray-200 py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-sm text-gray-400">
            ...
            <p class="mt-1">Developed for Internal Tenaga Ahli Team.</p>
        </div>
    </footer>
